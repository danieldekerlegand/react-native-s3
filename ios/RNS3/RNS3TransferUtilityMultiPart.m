//
//  RNS3TransferUtilityMultiPart.m
//  RNS3
//
...
#import "RNS3TransferUtilityMultiPart.h"
...
@implementation RNS3TransferUtilityMultiPart
...
RCT_EXPORT_METHOD(initializeRNS3) {
    ...
    [transferUtility enumerateToAssignBlocksForUploadTask:^(AWSS3TransferUtilityUploadTask * _Nonnull uploadTask, AWSS3TransferUtilityProgressBlock  _Nullable __autoreleasing * _Nullable uploadProgressBlockReference, AWSS3TransferUtilityUploadCompletionHandlerBlock  _Nullable __autoreleasing * _Nullable completionHandlerReference) {
        ...
        *multiPartUploadProgressBlockReference = self.uploadProgress;
    ...
    //  [transferUtility
    //    enumerateToAssignBlocksForUploadTask:     ^(AWSS3TransferUtilityMultiPartUploadTask * _Nonnull uploadTask,
    //      AWSS3TransferUtilityMultiPartProgressBlock  _Nullable __autoreleasing * _Nullable uploadProgressBlockReference,
    //      AWSS3TransferUtilityMultiPartUploadCompletionHandlerBlock  _Nullable __autoreleasing * _Nullable completionHandlerReference
    //    ) {
    ...
    [[[transferUtility getUploadTasks] continueWithBlock:^id(AWSTask *task) {
        if (task.result) {
            ...
            for (AWSS3TransferUtilityMultiPartUploadTask *task in uploadTasks) {
                ...
                if ([task transferID] == taskIdentifier) {
                    result = @{
                               @"type":@"upload",
                               @"task":task
                               };
